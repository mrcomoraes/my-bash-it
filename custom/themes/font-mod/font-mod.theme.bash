...
USER_HOST_THEME_PROMPT_PREFIX="${bold_yellow}"
...
function prompt_command() {
	...
	awsume_current_profile="${purple}|${AWSUME_PROFILE}|"
    fi
    ...
    PS1="$(clock_prompt)${virtualenv}$(user_host_prompt)${bold_cyan}\W $(scm_prompt_char_info)${awsume_current_profile}${ret_status}→ ${normal}"
}
